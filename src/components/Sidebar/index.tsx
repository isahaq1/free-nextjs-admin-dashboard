    ...
    menuItems: [
      {
        ...
        permission: "",
        children: [
          { label: "Dashboard One", route: "/", permission: "" },
          { label: "Dashboard Two", route: "/dashboard/two/", permission: "" },
          {
            label: "Dashboard Three",
            route: "/dashboard/three/",
            permission: "",
          },
        ],
      },
      ...
      },
      {
        icon: (
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M0 0h2048v2048H0z" fill="fil4" />
          </svg>
        ),
