...
const Dashboard = () => {
  ...
  const incomePieOptions = {
    ...
    labels: ["Sales", "Discount Given", "Other"],
    colors: ["#A5D8E6", "#4CAF50", "#FF5200"],
    legend: {
      position: "bottom",
    },
    responsive: [
  ...
  const incomePieSeries = [40912124.32, 5000000, 6000000];
  ...
  const columnChartSeries = [
    ...
    },
    {
      name: "Expenses",
      data: [
        2563695, 2400000, 20800000, 2300000, 2600000, 2500000, 2700000, 2400000,
